...
<div>
	...
	<p> Now for this particular post, I will need to introduce a couple vocabulary words:
		<ul>
			<ls> guiri [guee-ree]: the slang that Spaniards use for foreigners, particularly white ones from the US, Canada, etc. </ls>
			<ls> paki [pa-kee]: a small supermarket, usually owned by Pakistanis, that sells random stuff. notorious for selling alcohol to underage people and open 24/7 </ls>
		</ul>
	</p>
...
<div class="nameText"> Paki: </div> <div class="dialogText"> "Put that back, I can't sell you alcohol" </div> 
<div class="nameText"> Mana: </div> <div class="dialogText"> *sigh* "why? do you need to see my ID?" </div>
<div class="nameText"> Paki: </div> <div class="dialogText"> "No, because of the time of night" </div> 
<div class="nameText"> Mana: </div> <div class="dialogText"> "What do you mean? Is it illegal?" </div>
<div class="nameText"> Paki: </div> <div class="dialogText"> *getting upset for no reason* "You, where are you from?" </div> 
<div class="nameText"> Mana: </div> <div class="dialogText"> "I'm not from here, I'm a guiri" </div>
<div class="nameText"> Paki: </div> <div class="dialogText"> *pointing at the door* "YOU, GUIRI, OUT" </div> 
<div class="nameText"> Mana: </div> <div class="dialogText"> "uhhhh okay" </div>
